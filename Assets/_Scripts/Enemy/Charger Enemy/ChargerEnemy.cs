...
public class ChargerEnemy : MonoBehaviour
{
    ...
    public enum State
    {
        ...
        Attack,         // Attack (Charge forward and hit)
    ...
    // CHARGE ATTACK DATA
    // ========================================
    [SerializeField] private float forwardForceX = 10f; // how much forward force to apply during charge attack
    ...
    private void ChangeState(State newState)
    {
        ...
        switch (newState)
        {
            ...
            case State.Attack:
                ...
                // apply forward force in animation event to sync with attack hitbox
                break;
    ...
    public void ApplyForwardForce()
    {
        ...
        rb.linearVelocity = Vector2.zero;
        int dir = facingRight ? 1 : -1;
        Vector2 force = new Vector2(dir * forwardForceX, 0f);
        rb.AddForce(force, ForceMode2D.Impulse);
    }
}