...
public static class MathQuestionDatabase
{
    public static List<MathQuestion> GetHardcodedQuestions(MathTopic topic, QuestionDifficulty difficulty)
    {
        ...
        {
            list.Add(new MathQuestion(topic, difficulty, "How many ways can you arrange C, B, and A?", "6"));
            list.Add(new MathQuestion(topic, difficulty, "How many ways can you arrange 1, 2, and 3?", "6"));
            list.Add(new MathQuestion(topic, difficulty, "Arrange 2 out of 3 books", "6"));
        }
